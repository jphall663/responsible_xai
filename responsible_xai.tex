...
\item Use transparent ML mechanisms for systems that affect humans.
...
\subsection{Use Transparent ML Mechanisms for Systems That Affect Humans.} \label{sec:white_box}
